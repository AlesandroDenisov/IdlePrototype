...
public class ExplodingProjectile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (Missile)
        {
            ...
            //missileTarget = GameObject.FindWithTag("Player").transform;
        }
...
/*    private void OnAttack()
    ...
    private bool Hit(out Collider hit)
    {
        ...
        hit = _hits.FirstOrDefault(c => c.CompareTag("Enemy"));
        return hitAmount > 0;
    }

    private Vector3 StartPoint()
    {
        return new Vector3(transform.position.x, transform.position.y, transform.position.z) + transform.forward * EffectiveDistance;
    }*/
...
/*            // Apply damage if the hit object has IHealth component
...
/*            // Apply damage if the hit object has IHealth component
            ...
            {
                var healthComponent = collision.collider.GetComponent<IHealth>();
                if (healthComponent != null)
                {
                    healthComponent.TakeDamage(Damage);
                }
